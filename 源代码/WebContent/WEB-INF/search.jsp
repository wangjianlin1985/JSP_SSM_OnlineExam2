...
<html>
	...
	<!-- 工具栏 -->
	<div id="tb">
		班级：<input class="easyui-textbox" id="clazzid">
		考生姓名：<input class="easyui-textbox" id="username">
		考试情况：<select name="exam" id="exam" class="easyui-combobox" panelHeight="auto">
	...
	//查询
	function search(){
			$('#myTable').datagrid("load",{"stu_name":$("#username").val(),"clazz.clazz_name":$("#clazzid").val(),"texam.exam_statu":$("#exam").val()});
	}
	function usermana(){
			...
			columns: [
				[{
					...
					},
					{
						...
						width: 80,
						formatter:function(value,rowData,rowIndex){
							return rowData.texam.exam_name;
						}
					},
					{
						field: 'exam_statu',
						...
						width: 80,
						formatter:function(value,rowData,rowIndex){
							return rowData.texam.exam_statu;
						}
					},
					{
						field: 'exam_score',
						...
						width: 70,
						formatter:function(value,rowData,rowIndex){
							return rowData.texam.exam_score;
						}
					}
				]
			],
